...
INSERT INTO public.chapter_videos (id, chapter_id, title, "order", youtube_id, source, is_primary) VALUES
  ...
  (gen_random_uuid(), '20000000-0000-0000-0000-000000000002', 'Build an LLM from Scratch 2 — Working with Text Data', 1, 'GRojbL5dGJM', 'raschka', true),
  (gen_random_uuid(), '20000000-0000-0000-0000-000000000003', 'Build an LLM from Scratch 3 — Coding Attention Mechanisms', 1, 'HGbHfOFf4fU', 'raschka', true),
