...
export function SignInPage() {
  return (
    <div style={GRAPH_PAPER_BG} className="min-h-screen flex flex-col">
      ...
      <main className="flex-1 flex items-center justify-center px-6 py-16">
        <div className="w-full max-w-5xl grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
          ...
          <div>
            ...
            >
              <p className="font-jetbrains text-[10px] tracking-[0.15em] uppercase" style={{ color: "#A08E6B" }}>
                Sign in to sync your progress
              </p>

              {/* Google button */}
              <button
                onClick={() => signIn("google", { callbackUrl: "/chapter/ch01" })}
              ...
              <div className="flex items-center gap-3">
                ...
                <span className="font-jetbrains text-[9px]" style={{ color: "#A08E6B" }}>or</span>
                <div className="flex-1 h-px" style={{ background: "#C8B882", opacity: 0.5 }} />
              </div>
              ...
              <Link
                href="/chapter/ch01"
                className="block text-center font-jetbrains text-[10px] tracking-[0.08em] uppercase transition-colors"
                style={{ color: "#8B7355" }}
                onMouseEnter={(e) => {
            ...
            <p className="font-jetbrains text-[9px] mt-4" style={{ color: "#A08E6B" }}>
              Progress is saved locally when browsing as guest. Sign in to sync across devices.
            </p>
          </div>
      ...
      <footer
        className="py-5 px-6"
        style={{ borderTop: "1px solid #C8B882" }}
      >
